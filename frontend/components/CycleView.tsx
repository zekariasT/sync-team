...
export default function CycleView({ teamId }: { teamId?: string }) {
  ...
  return (
    <div className="flex-1 flex flex-col bg-background overflow-y-auto p-6 max-w-4xl mx-auto w-full gap-6">
      <CreateCycleModal
        isOpen={isModalOpen}
