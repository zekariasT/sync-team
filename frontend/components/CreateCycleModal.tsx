      ...
      <div className="relative w-full max-w-sm max-h-[90vh] overflow-y-auto bg-background border border-border rounded-xl shadow-2xl p-5 sm:p-6 animate-in fade-in zoom-in duration-200">
        ...
        <div className="flex flex-col gap-3 mt-8">
          <button
            ...
            disabled={!name.trim()}
            className="w-full py-2.5 bg-primary text-primary-foreground text-sm font-bold rounded-lg hover:bg-[var(--primary-hover)] disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg shadow-brand/20"
          >
            Create Cycle
          </button>
        </div>
