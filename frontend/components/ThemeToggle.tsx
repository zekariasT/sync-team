...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="p-2 rounded-md border border-primary/20 hover:bg-primary/10 transition-colors text-primary relative flex items-center justify-center w-10 h-10"
