...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="p-2 rounded-md border border-border hover:bg-muted transition-colors text-primary relative flex items-center justify-center w-10 h-10 cursor-pointer"
